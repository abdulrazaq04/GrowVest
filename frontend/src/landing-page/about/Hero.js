...
function Hero() {
    ...
    <div className="container">
        ...
        <div className="row p-5 border-top">
            <div className="col-6 p-5 text-muted fs-5">
                <p>
            ...
            <div className="col-6 p-5 text-muted fs-5">
                ...
                <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="#" className="text-decoration-none">blog</a> or see what the media is <a href="#" className="text-decoration-none">saying about us</a> or learn more about our business and product <a href="#" className="text-decoration-none">philosophies.</a>
                </p>
            </div>
        </div>
    </div>
